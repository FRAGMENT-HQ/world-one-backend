...
from .models import Forex, Order, Visa, Ticket, Passport,UserQuery,Pan,ExtraDocument,Resume
...
class ForexViewSet(viewsets.ModelViewSet):
    ...
    def get_rate(self, request, *args, **kwargs):
        ...
        resp = requests.get(f'https://v6.exchangerate-api.com/v6/6ea75b8d7b7bc5a29831df19/latest/INR')
        data = resp.json()
